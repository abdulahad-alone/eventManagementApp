...
public class Service_book_details extends AppCompatActivity {
    ...
    public String orderNumber,totalNoOf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_service_book_details);
        ...
        if (intent != null) {
            ...
            BookingDates = intent.getStringArrayListExtra("BookingDates");
            ...
            manydays = intent.getStringExtra("manydays");
            totalNoOf = intent.getStringExtra("totalNoOf");
        }
       // bookingdays.setText("Booked for "+ AndroidUtil.formatedDate(bookingDate)+" at "+AndroidUtil.formatTime(bookingTime));
        total_number_of_persons.setText(totalNoOf+ " "+ServiceName+" for "+BookingDates.size() +" days");
