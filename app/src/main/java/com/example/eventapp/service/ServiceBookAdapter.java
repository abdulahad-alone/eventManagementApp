...
public class ServiceBookAdapter extends RecyclerView.Adapter<ServiceBookAdapter.ViewHolider>{
    ...
    public ServiceBookAdapter(Context context, List<serviceModel> productList, ItemListener itemListener,
    ...
    @NonNull
    @Override
    public ServiceBookAdapter.ViewHolider onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context)
                .inflate(R.layout.show_booking_items,parent,false);
        return new ServiceBookAdapter.ViewHolider(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ServiceBookAdapter.ViewHolider holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(context, Service_book_details.class);
                intent.putExtra("ServiceName", productList.get(position).getTitle());
                ...
                intent.putExtra("BookingDates", productList.get(position).getBookingDates());
                intent.putExtra("description", productList.get(position).getDescription());
                intent.putExtra("ServiceRef", productList.get(position).getServiceRef());
                ...
                intent.putExtra("manydays", productList.get(position).getManydays());
                intent.putExtra("totalNoOf", productList.get(position).getTotalNoOf());
